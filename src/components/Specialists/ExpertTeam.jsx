  ...
  const teamMembers = [
    {
      ...
      description:
        "Specializes in personalized dietary plans that optimize metabolic health and support sustainable...",
      image: Maariya,
      delay: "0s",
    },
    {
      ...
      description:
        "Expert in non-invasive aesthetic treatments, focusing on skin rejuvenation and advanced...",
      image: Hemakshi,
      delay: "0.1s",
    },
    {
      ...
      description:
        "Focused on minimally invasive surgical techniques for weight loss and correcting metabolic...",
      image: Nikilesh,
      delay: "0.2s",
    },
    {
      ...
      description:
        "Renowned for her artistic approach to surgical body contouring and restorative...",
      image: Prema,
      delay: "0.3s",
    },
  ];
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Meet the dedicated professionals committed to your wellness and
          aesthetic goals.
        </p>
      </div>
